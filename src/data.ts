...
export const workExperiences = [
  {
    ...
    details: [
      "<strong>Designed and developed a new location-based, cost-per-click bidding system</strong> for <a href='https://bookingbuddy.com' target='_blank' rel='noreferrer' style='text-decoration: underline;'>BookingBuddy</a> website, with attribute-based bid modifiers and location hierarchy support.",
      "Migrated our old Location Service API and ETL service from Java to Go, powering queries for more than 200k locations globally. Rewritten from scratch and optimized for performance and cost efficiency. Search suggestions are powered by AWS OpenSearch.",
